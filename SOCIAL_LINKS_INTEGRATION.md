...
- **Telegram News**: t.me/RhizaCoreNews
- **Telegram Discussion**: t.me/RhizaCore  
- **Facebook**: facebook.com/RhizaCore
...
- Telegram and Facebook SVG icons
...
1. Landing page footer shows official social links
2. Settings page shows social links above footer
3. Sidebar (desktop) shows social links in footer section
...
export const SOCIAL_LINKS = [
  {
    name: 'Platform Name',
    url: 'https://...',
    icon: 'icon-name', // telegram, facebook, twitter, etc.
    label: 'Display Label'
  }
];
```
