...
const MiningNodes: React.FC = () => {
  ...
  const nodeTiers: NodeTier[] = [
    // Test Node (Only for development mode - 0.5 TON)
    ...(import.meta.env.DEV ? [{
      id: 'test-001',
      ...
      referralDirect: 5,
      referralIndirect: 2,
      features: ['Test Activation', 'Minimal Mining', 'For Testing Only', 'Development Only'],
    ...
    // Standard Tier - No activation fee if already activated
    {
      ...
      referralDirect: 5,
      referralIndirect: 2,
      features: ['', '', 'Standard Support', 'Referral Commissions'],
    ...
    },
    {
      ...
      referralDirect: 5,
      referralIndirect: 2,
      features: ['Priority Support', 'Referral Commissions'],
    ...
    // Premium Tier - $45 tier activation (always charged, separate from wallet activation)
    {
      ...
      referralDirect: 7,
      referralIndirect: 3,
      features: ['Early Beta Access', 'Premium Support', 'Enhanced Referrals'],
    ...
    },
    {
      ...
      referralDirect: 7,
      referralIndirect: 3,
      features: [ 'Early Beta Access', 'VIP Support', 'Enhanced Referrals'],
    ...
    // VIP Tier (Shareholders) - $120 tier activation (always charged, separate from wallet activation)
    {
      ...
      referralDirect: 10,
      referralIndirect: 5,
      features: [ 'Governance Rights', 'Exclusive Airdrops', 'NFT Certificate', 'White-Glove Support', 'Private Community'],
    ...
    },
    {
      ...
      referralDirect: 10,
      referralIndirect: 5,
      features: ['Full Governance Rights', 'Priority Airdrops', 'Gold NFT Certificate', 'Dedicated Support', 'Strategy Calls'],
      gradient: 'from-purple-600 to-pink-600',
      icon: Crown,
      badge: 'Elite'
    },
    {
      ...
      referralDirect: 10,
      referralIndirect: 5,
      features: [ 'Full Governance Rights', 'Guaranteed Airdrops', 'Platinum NFT Certificate', 'Core Team Access', 'Quarterly Calls'],
      gradient: 'from-purple-600 to-pink-600',
      icon: Crown,
      badge: 'Ultimate'
    }
