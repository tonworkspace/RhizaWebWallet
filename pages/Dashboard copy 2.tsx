...
//       primary ? 'bg-white/20 dark:bg-black/10' : 'bg-white dark:bg-white/5'
//     }`}>
...
//       primary ? 'text-white dark:text-black/80' : 'text-slate-500 dark:text-white/50'
//     }`}>{label}</span>
//   </button>
// );
...
//   // Calculate combined portfolio value (TON + RZC + Jettons)
//   // `totalUsdValue` uses `balance` from useWallet, which is synced to the active wallet.
//   const combinedPortfolioValue = totalUsdValue + rzcUsdValue + jettonsUsdValue;
...
//     items.push({
//       id: 'rhizaswap-launch',
//       title: "RhizaSwap Launching",
//       badge: "Coming Soon",
//       ping: true,
//       message: "RhizaSwap RZC/USDT market launching soon! Secure your RZC at $0.12 floor price now",
...
//     if (effectiveTonBalance > 0 || !hideDust) {
//       list.push({
...
//   }, [combinedPortfolioValue, rzcBalance, rzcUsdValue, tonBalance, totalUsdValue, multiChainBalances, currentEvmChain, activeEvmPrice, hideDust, contextRzcPrice, jettons, rzcChange24h]);
...
//       verified: ['ton'].includes(asset.id),
//     };
//   };
...
//                   <span className="text-[8px] sm:text-[9px] font-bold text-slate-600 dark:text-emerald-500/80 uppercase tracking-widest truncate group-hover/ticker:text-emerald-600 dark:group-hover/ticker:text-emerald-400">
...
//                           {item.symbol}
//                         </span>
//                         <span className={`text-[9px] font-numbers font-bold ${item.color}`}>
//                           {item.price}
//                         </span>
//                       </span>
//                     ))}
...
//                       <span className={`text-[9px] sm:text-[10px] font-heading font-black uppercase text-transparent bg-clip-text bg-gradient-to-br ${currentRank.color}`}>Lvl {currentRank.level}</span>
...
//                            </button>
//                            <span className="text-[7.5px] font-black uppercase tracking-widest text-red-500/80 mt-1 animate-pulse">⚠️ R1 Closing</span>
//                         </div>
//                       )}
//                     </div>
...
//                               className="flex items-center justify-between px-2 py-2.5 rounded-xl hover:bg-slate-50 dark:hover:bg-white/[0.04] transition-all cursor-pointer group border border-transparent hover:border-slate-100 dark:hover:border-white/[0.06] active:scale-[0.99]"
//                             >
//                               {/* Logo */}
//                               <div className="flex items-center gap-3">
//                                 <div className={`w-9 h-9 rounded-full flex items-center justify-center flex-shrink-0 ring-1 ring-black/5 dark:ring-white/10 ${
//                                   asset.isCore
//                                     ? 'bg-gradient-to-br from-emerald-400 to-cyan-500 text-white font-black text-[10px] shadow-md shadow-emerald-500/20'
...
//         {/* Trade Simulator CTA */}
//         <div
//           onClick={() => navigate('/wallet/trade-simulator')}
...
//             style={{ backgroundImage: `linear-gradient(#fff 1px,transparent 0),linear-gradient(90deg,#fff 1px,transparent 0)`, backgroundSize: '24px 24px' }} />
//           <div className="relative flex items-center gap-4 p-4">
//             <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-emerald-500 to-cyan-500 flex items-center justify-center flex-shrink-0 shadow-lg shadow-emerald-500/30">
//               <TrendingUp size={22} className="text-black" />
//             </div>
//             <div className="flex-1 min-w-0">
//               <div className="flex items-center gap-2 mb-0.5">
//                 <span className="font-black text-white text-sm">RZC/USDT Simulator</span>
//                 <span className="text-[9px] bg-amber-500/20 text-amber-400 px-1.5 py-0.5 rounded-full font-black uppercase tracking-wider">Paper Trading</span>
//               </div>
//               <p className="text-xs text-slate-400">Practice buying &amp; selling RZC with $1,000 virtual USDT. Zero risk.</p>
//             </div>
//             <ArrowRight size={18} className="text-slate-500 group-hover:text-emerald-400 group-hover:translate-x-1 transition-all flex-shrink-0" />
//           </div>
//         </div>
