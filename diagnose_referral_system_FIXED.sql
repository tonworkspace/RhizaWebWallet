-- ============================================================================
-- REFERRAL SYSTEM DIAGNOSTIC QUERIES (FIXED VERSION)
...
-- ============================================================================
-- 12. CHECK TABLE SCHEMA (Verify columns exist)
-- ============================================================================
SELECT 
  table_name,
  column_name,
...
-- Set all users as active (if is_active is NULL)
-- UPDATE wallet_users SET is_active = true WHERE is_active IS NULL;

-- ============================================================================
-- NOTES
-- ============================================================================
-- wallet_rzc_transactions columns:
--   - id (UUID)
--   - user_id (UUID, FK to wallet_users)
--   - type (TEXT) - 'signup_bonus', 'referral_bonus', 'milestone_bonus', etc.
--   - amount (NUMERIC)
--   - balance_after (NUMERIC)
--   - description (TEXT) - NOT 'source'!
--   - metadata (JSONB)
