...
import { X, Sparkles, ArrowRight, Wallet as WalletIcon, CheckCircle, FileText, Zap } from 'lucide-react';
        ...
        <div className="relative p-6 sm:p-8 text-center space-y-5">
          ...
          <div className="space-y-3 pt-2">
            ...
            <button
              ...
              disabled={isNavigating}
              className="w-full p-4 bg-gradient-to-br from-emerald-500 to-cyan-500 hover:from-emerald-400 hover:to-cyan-400 disabled:opacity-50 rounded-2xl transition-all hover:scale-[1.02] active:scale-[0.98] disabled:cursor-not-allowed disabled:scale-100 text-left group shadow-lg shadow-emerald-500/30"
            >
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-1 mt-2 text-white font-bold text-xs uppercase tracking-wider">
            ...
            <button
              ...
              disabled={isNavigating}
              className="w-full p-4 bg-white dark:bg-white/5 hover:bg-gray-50 dark:hover:bg-white/10 disabled:opacity-50 border-2 border-gray-200 dark:border-white/10 rounded-2xl transition-all hover:scale-[1.02] active:scale-[0.98] disabled:cursor-not-allowed disabled:scale-100 text-left group"
            >
              <div className="flex items-start gap-3">
                <div className="w-12 h-12 rounded-xl bg-blue-500/10 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
                  <WalletIcon size={24} className="text-blue-600 dark:text-blue-400" />
                </div>
                <div className="flex-1 min-w-0">
                  <p className="text-base font-black text-gray-900 dark:text-white uppercase tracking-wide mb-1">
                    I Have Pre-Mined Tokens
                  </p>
                  <p className="text-sm text-gray-600 dark:text-gray-400 font-medium leading-relaxed">
                    Migrate your RZC tokens from the old system
                  </p>
                  <div className="flex items-center gap-1 mt-2 text-blue-600 dark:text-blue-400 font-bold text-xs uppercase tracking-wider">
                    Migrate Now <ArrowRight size={14} />
                  </div>
                </div>
              </div>
            </button>
