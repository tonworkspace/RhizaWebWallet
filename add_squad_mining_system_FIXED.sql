-- =====================================================
-- SQUAD MINING SYSTEM - Database Migration (FIXED)
-- =====================================================
-- This adds squad mining functionality to the referral system
-- FIXED: Changed user_id type from TEXT to UUID to match wallet_users.id
...
-- 2. Create squad_claims table to track all claims (FIXED: user_id is UUID)
...
-- 4. Create function to claim squad rewards (FIXED: p_user_id is UUID)
...
-- 5. Create function to get squad mining stats (FIXED: p_user_id is UUID)
...
-- Check wallet_users.id data type
SELECT column_name, data_type 
FROM information_schema.columns 
WHERE table_name = 'wallet_users' 
AND column_name = 'id';
...
-- MIGRATION COMPLETE ✅
-- =====================================================
-- All user_id references now use UUID type to match wallet_users.id
