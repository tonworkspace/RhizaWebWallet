-- ============================================================================
-- FIX: Remove discrepancy_amount from INSERT (it's a GENERATED column)
-- The column is computed automatically as (claimed_balance - current_balance)
-- ============================================================================
...
BEGIN
  ...
  -- Insert the request (exclude discrepancy_amount — it's a GENERATED column)
